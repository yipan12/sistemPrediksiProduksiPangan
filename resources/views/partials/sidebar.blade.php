...
<div id="sidebar" class="bg-white text-black border  vh-100 p-3 sidebar position-fixed">
    <h4 class="text-black mb-4 text-center text-bold text-gradient">Kelompok 2</h4>
            ...
            <ul class="collapse list-unstyled ps-4" id="submenuPrediksi">
                <li>
                    <a class="nav-link {{ request()->routeIs('prediksi-pangan') ? 'text-primary fw-bold' : 'text-black' }}" href="{{ route('prediksi-pangan') }}">
                        <i class="fas fa-chart-line me-2"></i> Lihat Prediksi
                    </a>
                </li>
                <li>
                    <a class="nav-link {{ request()->routeIs('prediksi-pangan2') ? 'text-primary fw-bold' : 'text-black' }}" href="{{ route('prediksi-pangan2') }}">
                        <i class="fas fa-plus me-2"></i> Buat Prediksi
                    </a>
                </li>
            </ul>
        </li>
